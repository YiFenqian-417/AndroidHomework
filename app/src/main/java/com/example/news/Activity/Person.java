...
import com.example.news.RecycleView.LikesAdapter;
...
public class Person extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int flag = LitePal.deleteAll(Likes.class);
                if(flag>1)Toast.makeText(Person.this,"恭喜你，删除成功",Toast.LENGTH_SHORT).show();
                else Toast.makeText(Person.this,"很遗憾,删除失败",Toast.LENGTH_SHORT).show();
            }
        });
        RecyclerShow();
    ...
    public void RecyclerShow(){
        recyclerView = findViewById(R.id.like_recycleview);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        likesList = LitePal.findAll(Likes.class);
        Collections.reverse(likesList);
        for(Likes model: likesList){
            Log.d(TAG, "onCreate: "+model.getTitle());
        }

        likesAdapter = new LikesAdapter(Person.this,likesList);
                    ...
                    public void onBoomButtonClick(int index) {
                        switch (index){
                            ...
                            case 1:
                                ...
                                Intent intent1 = new Intent(Person.this,ClickedHistory.class);
                            ...
                            case 3:
                                ...
                                Intent intent3 =  new Intent(Person.this,MainActivity.class);
                            ...
                            case 4:
                                ...
                                Intent intent4 =  new Intent(Person.this,MainActivity.class);
                            ...
                            case 5:
                                ...
                                Intent intent5 =  new Intent(Person.this,MainActivity.class);
                            ...
                            case 6:
                                ...
                                Intent intent6 =  new Intent(Person.this,MainActivity.class);
                            ...
                            case 7:
                                ...
                                Intent intent7 =  new Intent(Person.this,MainActivity.class);
                            ...
                            case 8:
                                ...
                                Intent intent8 =  new Intent(Person.this,MainActivity.class);
